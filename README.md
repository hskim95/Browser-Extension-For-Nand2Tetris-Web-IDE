...
**"Nand to Tetris"** is an computer educational project developed by Noam Nisan & Shimon Schocken. 

(Official website: <https://www.nand2tetris.org/>)

This project is an **independent, unofficial tool** designed to assist learners working with the Web-IDE(<https://nand2tetris.github.io/web-ide/>).<br>
It is **not affiliated with**, **endorsed by**, or **associated with** the original authors or the official Nand to Tetris project.


본 프로젝트에서 언급되는 "Nand to Tetris"는 Noam Nisan과 Shimon Schocken이 개발한 컴퓨터 교육용 프로젝트입니다. 

(공식 홈페이지: <https://www.nand2tetris.org/>)

이 프로젝트에서 개발한 확장앱은 Web-IDE(<https://nand2tetris.github.io/web-ide/*/>) 사용자의 학습 편의를 위해 **비공식적**으로 개인이 제작했으며, <br>원작자 또는 "Nand to Tetris" 프로젝트와 공식적으로 **아무런 관련이 없음**을 밝힙니다.
